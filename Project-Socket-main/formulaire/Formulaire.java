    ...
    public String getHTMLString() {
        ...
        for(Champ champ : this.listeChamp) {
            if(champ.getChamp() instanceof JTextField && champ.isVisible()) {
                html += "<label forName="+champ.getAttribut().getName()+" class=\"labelInput\">"+champ.getLabel().getText()+"</label> <input type=\"text\" name=\""+champ.getAttribut().getName()+"\" class=\""+champ.getCss()+"\" id="+champ.getAttribut().getName()+" value=\""+champ.getDefaultValue()+"\">\n";
            } else if(champ.getChamp() instanceof DropDown && champ.isVisible()) {
                html += "<p>"+champ.getLabel().getText()+" <select name=\""+champ.getAttribut().getName()+"\" style=\""+champ.getCss()+"\">\n";
        ...
        html+="<input class=\"ok\" type=\"submit\" value=\"OK\">";
        return html;
    }
